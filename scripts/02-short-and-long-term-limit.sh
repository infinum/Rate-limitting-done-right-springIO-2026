...
read -rp "Press Enter to start Phase 2: Sudden burst..."
echo ""
echo "=== Phase 2: Sudden burst (15 req at once) — short-term limit kicks in ==="
...
read -rp "Press Enter to start Phase 4: Drain the hourly budget..."
echo ""
